...
import { Map, Upload, Link2, Trash2 } from 'lucide-react';
...
export const MapControlsModal = ({ open, onOpenChange, fabricCanvas }: MapControlsModalProps) => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Add and manage maps for your tabletop
          </DialogDescription>
        </DialogHeader>
