    ...
    try {
      ...
      const projectData: ProjectData = {
        ...
        fogData: {
          ...
          revealAll: fogState.revealAll,
          visionRange: fogState.visionRange,
          fogOpacity: fogState.fogOpacity,
          exploredOpacity: fogState.exploredOpacity,
          ...
          useGradients: fogState.useGradients,
          innerFadeStart: fogState.innerFadeStart,
